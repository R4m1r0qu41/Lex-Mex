...
/// Case-insensitive: LGTOC's Capítulo V Bis (`Artículo 228 a.-` …
/// `228 v.-`, DOF 31-12-1946) writes its letter suffix lowercase, the same
/// grammar position as an uppercase suffix elsewhere, just cased
...
/// matched case-insensitively against [`SUFFIX_LETTERS`].
#[must_use]
