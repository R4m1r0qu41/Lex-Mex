...
La documentación que las [Instituciones](articulo-2.md) utilicen relacionada con la oferta, solicitud y contratación de fianzas o la derivada de éstas, así como los modelos de cláusulas elaborados para ser incorporados mediante endosos adicionales a dichos contratos, deberá registrarse ante la [Comisión](articulo-2.md) de manera previa a su ofrecimiento, en la forma y términos que la misma establezca mediante disposiciones de carácter general.
