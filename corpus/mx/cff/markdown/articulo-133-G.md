...
La resolución del recurso de revocación exclusivo de fondo se emitirá en el sentido de confirmar el acto impugnado, dejar sin efectos el mismo, modificarlo o dictar uno nuevo que lo sustituya, en términos de lo dispuesto por el artículo [133](articulo-133.md), fracciones II, IV y V de este Código. La resolución será favorable al promovente cuando:
...
Para el cumplimiento de las resoluciones del recurso de revocación exclusivo de fondo, será aplicable lo dispuesto en el artículo [133-A](articulo-133-A.md) de este Código.
