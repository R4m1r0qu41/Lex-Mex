...
La [Secretaría](articulo-2.md) administrará a través de la [Plataforma](articulo-2.md), un registro electrónico de personas físicas y morales que participen en los procedimientos de contratación regulados por esta Ley, el cual contendrá entre otros, sus datos de identidad, objeto social y datos fiscales.
