...
La aplicación de los procedimientos de ajuste de costos directos o del factor de actualización a que se refiere el [artículo anterior](articulo-57.md) se sujetará a lo siguiente:
...
Para efectos de cada una de las revisiones y ajustes de los costos directos, que se presenten durante la ejecución de los trabajos, el mes de origen de éstos será el correspondiente al acto de presentación y apertura de proposiciones, aplicándose a las estimaciones que procedan, el último factor de ajuste de costos acumulado que resulte de los factores autorizados; II. El factor de actualización para precios unitarios se determinará a partir del día siguiente que concluya el mes correspondiente a la fecha de presentación y apertura de las proposiciones o de la notificación de aceptación de la cotización hasta la fecha de inicio de los trabajos, siempre que hayan transcurrido más de sesenta días contados a partir de la fecha correspondiente a los actos mencionados;
...
V. A los demás lineamientos que para tal efecto emita la [Secretaría](articulo-2.md).
