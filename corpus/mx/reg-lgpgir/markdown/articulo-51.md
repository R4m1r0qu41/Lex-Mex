---
id: urn:lex-mx:federal:regulation:reg-lgpgir:article:51
...
number: "51"
aliases: ["REG-LGPGIR — Artículo 51"]
generated: true
...
Además de la documentación señalada en los artículos anteriores, de acuerdo con la actividad que se pretenda realizar, se anexará la siguiente:
...
20 a) El listado de insumos directos e indirectos que serán utilizados en el proceso de tratamiento, indicando sus nombres comerciales y la relación de alimentación para cada una de ellos. En el caso de los insumos directos, se indicará la cantidad a utilizar por metro cúbico de suelo a tratar, y
...
21 p) La determinación y categorización de los puntos, rutas y vías de exposición presentes y futuras;
