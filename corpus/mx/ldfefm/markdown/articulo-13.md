---
id: urn:lex-mx:federal:statute:ldfefm:article:13
...
Una vez aprobado el [Presupuesto de Egresos](articulo-2.md), para el ejercicio del gasto, las [Entidades Federativas](articulo-2.md) deberán observar las disposiciones siguientes:
...
VI. Deberán tomar medidas para racionalizar el [Gasto corriente](articulo-2.md).

Los ahorros y economías generados como resultado de la aplicación de dichas medidas, así como los ahorros presupuestarios y las economías que resulten por concepto de un costo financiero de la [Deuda Pública](articulo-2.md) menor al presupuestado, deberán destinarse en primer lugar a corregir desviaciones del [Balance presupuestario de recursos disponibles](articulo-2.md) negativo, y en segundo lugar a los programas prioritarios de la Entidad Federativa;
