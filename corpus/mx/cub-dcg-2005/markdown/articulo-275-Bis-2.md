---
id: urn:lex-mx:federal:regulation:cub-dcg-2005:article:275-bis-2
...
number: "275 Bis 2"
aliases: ["DCG-CUB-2005 — Artículo 275 Bis 2"]
generated: true
...
Las Instituciones estarán obligadas a realizar las acciones conducentes para que (265)
...
Los clientes podrán convenir con cualquier Institución o intermediario del mercado de valores con (265)

el que decidan celebrar un contrato de depósito y administración de valores, que estos realicen los trámites necesarios para dar por terminado el contrato que tengan celebrado con alguna Institución.

La Institución con la que el cliente haya decidido dar por terminado el contrato, estará obligada a (265)
...
Será responsabilidad de la Institución que solicite la transferencia de valores y recursos, así como la (265)

terminación del contrato correspondiente, el contar con la autorización del cliente o clientes de que se trate para la realización de los actos previstos en el presente artículo.

Si el cliente cuya terminación del contrato se solicite, objeta dicha terminación o la transferencia de (265)
