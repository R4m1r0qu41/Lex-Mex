---
id: urn:lex-mx:federal:regulation:reg-lgs-mt:article:10
...
number: "10"
aliases: ["REG-LGS-MT — Artículo 10"]
generated: true
...
El documento en el que se haga constar el consentimiento que otorguen las personas a que se refiere el párrafo primero del artículo 324 de la [Ley](articulo-2.md), será recabado por el [Coordinador Hospitalario](articulo-2.md), una vez que se certifique la pérdida de la vida.
...
III. Nombre y datos generales del Donador, entre ellos, fecha de nacimiento, domicilio y nacionalidad; IV. Relación del otorgante con el Donador que lo legitime a dar su consentimiento;
