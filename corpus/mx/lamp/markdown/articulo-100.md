---
id: urn:lex-mx:federal:statute:lamp:article:100
instrument_id: urn:lex-mx:federal:statute:lamp
instrument: LAmp
name: "Ley de Amparo"
provision_type: article
number: "100"
aliases: ["LAmp — Artículo 100"]
generated: true
...
En caso de que el escrito de expresión de agravios se presente en forma impresa, el o la recurrente deberá exhibir una copia del mismo para el expediente y una para cada una de las partes, señalando las constancias que en copia certificada deberán remitirse al órgano jurisdiccional que deba resolver el recurso. Esta exigencia no será necesaria en los casos que el recurso se presente en forma electrónica. Párrafo reformado DOF 13-03-2025
