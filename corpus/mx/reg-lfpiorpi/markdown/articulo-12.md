---
id: urn:lex-mx:federal:regulation:reg-lfpiorpi:article:12
...
number: "12"
aliases: ["REG-LFPIORPI — Artículo 12"]
generated: true
...
Quienes se hayan dado de alta en términos de lo establecido en el presente artículo y ya no realicen Actividades Vulnerables, deberán realizar su baja del padrón al que se refiere el artículo [4](articulo-4.md), fracción I, de este Reglamento, conforme a lo dispuesto en las reglas de carácter general. Dicha solicitud surtirá sus efectos a partir de la fecha en que sea presentada; en caso contrario, quienes se encuentren registrados deberán continuar presentando los Avisos o Informes correspondientes.
