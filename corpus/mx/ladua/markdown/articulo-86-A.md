---
id: urn:lex-mx:federal:statute:ladua:article:86-a
instrument_id: urn:lex-mx:federal:statute:ladua
instrument: LADUA
name: "Ley Aduanera"
provision_type: article
number: "86-A"
aliases: ["LADUA — Artículo 86-A"]
generated: true
...
II. Efectúen el tránsito interno o internacional de mercancías, por el monto que corresponda a las contribuciones y cuotas compensatorias que se determinen provisionalmente en el pedimento o las que correspondan tomando en cuenta el valor de transacción de mercancías idénticas o similares conforme a los artículos [72](articulo-72.md) y [73](articulo-73.md) de esta Ley, en los casos que señale el Servicio de Administración Tributaria, mediante reglas de carácter general. Lo dispuesto en esta fracción no será aplicable a las importaciones temporales que efectúen las maquiladoras y empresas con programas de exportación autorizados por la Secretaría de Economía, siempre que las mercancías se encuentren previstas en los programas respectivos.
...
III. Efectúen la introducción de mercancías extranjeras para destinarlas al régimen de recinto fiscalizado estratégico para el manejo, almacenaje, custodia, exhibición, venta o distribución; por el monto que corresponda a las contribuciones y cuotas compensatorias que se determinen provisionalmente en el pedimento, o las que correspondan tomando en cuenta el valor de transacción de mercancías idénticas o similares conforme a los artículos [72](articulo-72.md) y [73](articulo-73.md) de esta Ley en los casos que se señalen mediante reglas.
...
La garantía se cancelará cuando se tramite el pedimento correspondiente para retirar las mercancías extranjeras del recinto fiscalizado estratégico de conformidad con lo señalado en el artículo [135-D](articulo-135-D.md) de esta Ley, y se paguen las contribuciones y cuotas compensatorias.
