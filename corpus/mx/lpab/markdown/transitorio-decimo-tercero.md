---
id: urn:lex-mx:federal:statute:lpab:transitory:decimo-tercero
...
El [Instituto](articulo-5o.md) deberá administrar y enajenar los [Bienes](articulo-5o.md), con el fin de obtener el máximo valor de recuperación posible. El Instituto procurará las mejores condiciones de venta de los BIENES, siguiendo al efecto los procedimientos a que se refiere el Capítulo II del Título Tercero de esta Ley.

El Instituto deberá concluir los procesos de recuperación en un plazo máximo de cinco años a partir de la entrada en vigor del presente Decreto, con excepción de la venta o delegación de la administración de los activos de las instituciones intervenidas por la [Comisión](articulo-5o.md), que sean objeto de procesos de liquidación, el cual deberá concluirse en un plazo no mayor de tres años.

A ese efecto, el [Secretario Ejecutivo](articulo-5o.md) deberá elaborar un programa de enajenación de BIENES para la aprobación de la [Junta de Gobierno](articulo-5o.md) que deberá contener por lo menos los siguientes elementos:
