---
id: urn:lex-mx:federal:regulation:reg-lgeepa-anp:article:133-ter
...
number: "133 TER"
aliases: ["REG-LGEEPA-ANP — Artículo 133 TER"]
generated: true
...
Las solicitudes de modificación de los certificados deberán contener el número de certificado, el tipo de modificación que se pretenda llevar a cabo en términos del [artículo anterior](articulo-133-BIS.md), y la información y documentación siguientes:

I. Cuando se trate de modificación en la titularidad del predio:

a) El nombre del nuevo titular;

b) La manifestación del nuevo titular de que desea seguir destinando voluntariamente el predio a la conservación, así como de continuar aplicando la estrategia de manejo avalada por la Comisión o en su caso, las modificaciones que decida realizar a la misma. En su caso, acta de la asamblea ejidal o comunal realizada en términos de la Ley Agraria, en la que se exprese la voluntad de destinar sus predios a la conservación, para el caso de ejidos y comunidades;
