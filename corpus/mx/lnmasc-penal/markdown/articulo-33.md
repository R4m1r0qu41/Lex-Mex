---
id: urn:lex-mx:federal:statute:lnmasc-penal:article:33
...
number: "33"
aliases: ["LNMASC-PENAL — Artículo 33"]
generated: true
...
Requisitos de los [Acuerdos](articulo-3.md) En caso de que el [Mecanismo Alternativo](articulo-3.md) concluya con una solución mutuamente acordada por los [Intervinientes](articulo-3.md), el [Facilitador](articulo-3.md) lo hará constar por escrito con la siguiente información:
...
El Acuerdo deberá ser validado por un licenciado en derecho del [Órgano](articulo-3.md), del cual se incluirá su nombre y firma. Se entregará un ejemplar del Acuerdo a cada uno de los Intervinientes, conservándose uno en los archivos que corresponda.
