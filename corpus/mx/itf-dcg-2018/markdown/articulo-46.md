---
id: urn:lex-mx:federal:regulation:itf-dcg-2018:article:46
...
number: "46"
aliases: ["DCG-ITF-2018 — Artículo 46"]
generated: true
...
Las instituciones de financiamiento colectivo se asegurarán de que la información que se dé a conocer a los posibles [Inversionistas](articulo-2.md) cumpla con las siguientes características mínimas:
...
IV. Utilizar un tamaño de fuente similar al del texto de los principales contenidos de las publicaciones que se realicen a través de las [Plataformas](articulo-2.md).

V. Incluir una sección de preguntas frecuentes respecto de la forma de operar de la institución de financiamiento colectivo, de las solicitudes y proyectos que en ella se publican, así como, en su caso, los métodos de resolución de controversias o aclaraciones entre los [Solicitantes](articulo-2.md), Inversionistas y la institución de financiamiento colectivo.
