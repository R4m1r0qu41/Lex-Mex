---
id: urn:lex-mx:federal:regulation:itf-dcg-2018:article:86
...
number: "86"
aliases: ["DCG-ITF-2018 — Artículo 86"]
generated: true
...
Las instituciones de financiamiento colectivo deberán acompañar a la solicitud de autorización a que se refiere el [artículo anterior](articulo-85.md), lo siguiente:
...
g) Mantener registros de auditoría íntegros que incluyan la información detallada de los accesos o intentos de acceso y la operación o actividad efectuadas por los Usuarios de la [Infraestructura Tecnológica](../../lritf/markdown/articulo-4.md). Dichos registros deberán estar a disposición del personal autorizado de la institución de financiamiento colectivo.
...
i) Permitir a la institución de financiamiento colectivo realizar las revisiones de seguridad que se señalan en el artículo [64](articulo-64.md), fracciones II, III y IV de las presentes disposiciones a los servicios contratados o bien, proporcionar evidencia de la realización de estas revisiones.
...
IV. Los mecanismos que permitirán a la institución de financiamiento colectivo, mantener en sus instalaciones los registros detallados de todas las [Operaciones](../../lritf/markdown/articulo-4.md) que se realicen, así como de sus registros contables al cierre diario. Dichos registros deberán mantenerse en un formato que permita su consulta y uso, con independencia de que el servicio contratado con el tercero no se encuentre disponible.

V. Cuando el tercero tenga privilegios de acceso a las imágenes de identificaciones oficiales o información biométrica de los [Clientes](../../lritf/markdown/articulo-4.md), presentar evidencia de los controles que mantendrá para garantizar la confidencialidad, integridad y disponibilidad de esta información.

VI. Tratándose de contratación de servicios de [Cómputo en la Nube](articulo-2.md), describir adicionalmente lo siguiente:

a) Tipo de nube, ya sea pública, privada o híbrida.

b) Regiones específicas donde se almacenará y procesará la información.

c) En esquemas de nubes públicas o de virtualización en infraestructura compartida con otros clientes, la descripción de los mecanismos de control que serán utilizados para garantizar la confidencialidad, integridad y disponibilidad de la [Información Sensible](articulo-2.md).
...
VIII. Planes para evaluar y reportar al [Órgano de Administración](articulo-2.md) o, en su caso, al comité de auditoría de la institución de financiamiento colectivo, según la importancia del servicio contratado, el desempeño del tercero y el cumplimiento de la regulación aplicable relacionada con dicho servicio.
