---
id: urn:lex-mx:federal:code:cfpc:article:594
instrument_id: urn:lex-mx:federal:code:cfpc
instrument: CFPC
name: "Código Federal de Procedimientos Civiles"
provision_type: article
number: "594"
aliases: ["CFPC — Artículo 594"]
generated: true
...
> Título UNICO · Capítulo VI

# Artículo 594

Los miembros de la colectividad afectada podrán adherirse a la acción de que se trate, conforme a las reglas establecidas en este artículo. En el caso de las acciones colectivas en sentido estricto e individuales homogéneas, la adhesión a su ejercicio podrá realizarse por cada individuo que tenga una afectación a través de una comunicación expresa por cualquier medio dirigida al representante a que se refiere el artículo [585](articulo-585.md) de este Código o al representante legal de la parte actora, según sea el caso.
...
Los afectados que se adhieran a la colectividad durante la substanciación del proceso, promoverán el incidente de liquidación en los términos previstos en el artículo [605](articulo-605.md) de este Código.
