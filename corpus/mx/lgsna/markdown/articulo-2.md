...
V. Regular la organización y funcionamiento del [Sistema Nacional](articulo-3.md), su [Comité Coordinador](articulo-3.md) y su [Secretaría Ejecutiva](articulo-3.md), así como establecer las bases de coordinación entre sus integrantes;

VI. Establecer las bases, principios y procedimientos para la organización y funcionamiento del [Comité de Participación Ciudadana](articulo-3.md);
...
VIII. Establecer las acciones permanentes que aseguren la integridad y el comportamiento ético de los [Servidores públicos](articulo-3.md), así como crear las bases mínimas para que todo órgano del Estado mexicano establezca políticas eficaces de ética pública y responsabilidad en el servicio público;

IX. Establecer las bases del [Sistema Nacional de Fiscalización](articulo-3.md), y
