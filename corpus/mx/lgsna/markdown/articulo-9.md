---
id: urn:lex-mx:federal:statute:lgsna:article:9
instrument_id: urn:lex-mx:federal:statute:lgsna
instrument: LGSNA
name: "Ley General del Sistema Nacional Anticorrupción"
provision_type: article
number: "9"
aliases: ["LGSNA — Artículo 9"]
generated: true
temporal_status: effective
review_status: not_analyzed
source_url: https://www.diputados.gob.mx/LeyesBiblio/pdf/LGSNA_200521.pdf
source_sha256: 5edf7b5ad4dd65a9c97c02ec51f13499aa7ab5025f02ad6e9be3c948ff3cf185
---
...
El [Comité Coordinador](articulo-3.md) tendrá las siguientes facultades:
...
IV. Aprobar la metodología de los indicadores para la evaluación a que se refiere la fracción anterior, con base en la propuesta que le someta a consideración la [Secretaría Ejecutiva](articulo-3.md);
...
VI. Requerir información a los [Entes públicos](articulo-3.md) respecto del cumplimiento de la política nacional y las demás políticas integrales implementadas; así como recabar datos, observaciones y propuestas requeridas para su evaluación, revisión o modificación de conformidad con los indicadores generados para tales efectos;
...
X. El establecimiento de mecanismos de coordinación con los [Sistemas Locales](articulo-3.md) anticorrupción;
...
XIV. Celebrar convenios de coordinación, colaboración y concertación necesarios para el cumplimiento de los fines del [Sistema Nacional](articulo-3.md);

XV. Promover el establecimiento de lineamientos y convenios de cooperación entre las autoridades financieras y fiscales para facilitar a los [Órganos internos de control](articulo-3.md) y entidades de fiscalización la consulta expedita y oportuna a la información que resguardan relacionada con la investigación de faltas administrativas y hechos de corrupción en los que estén involucrados flujos de recursos económicos;
