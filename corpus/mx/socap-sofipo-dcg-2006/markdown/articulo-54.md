---
id: urn:lex-mx:federal:regulation:socap-sofipo-dcg-2006:article:54
...
number: "54"
aliases: ["DCG-SOCAP-SOFIPO-2006 — Artículo 54"]
generated: true
temporal_status: effective
review_status: not_analyzed
amendment_marks: [1,59,60,65,69]
...
Los manuales de operación de las Sociedades Financieras Populares deberán apegarse como mínimo a los lineamientos, políticas y objetivos establecidos por el Consejo y, en específico, a lo siguiente:
...
a) Promoción y otorgamiento de crédito: Los métodos de aprobación y otorgamiento de crédito, entre los cuales deberá estar el procedimiento de autorizaciones automáticas a que se refiere el artículo [58](articulo-58.md) de la presente Sección;
...
4. En caso de personas físicas, documentación que acredite su capacidad de pago;
...
1. Los periodos de amortización del crédito y, en su caso, aquéllos donde hubieren existido incumplimientos;

2. La actualización de la información que se tenga del acreditado, como por ejemplo, cambio de domicilio, cambio de fuente de ingresos, entre otros, y
...
d) Recuperación de cartera crediticia: Los mecanismos a seguir, sin distinción alguna, respecto de los casos de cartera crediticia que presente problemas de recuperación.
