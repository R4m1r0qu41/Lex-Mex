---
id: urn:lex-mx:federal:statute:lissste:transitory:septimo
...
A partir del día primero de enero de dos mil ocho, los Trabajadores tendrán seis meses para optar por el régimen previsto en el artículo décimo transitorio o por la acreditación de Bonos de Pensión del ISSSTE. Dentro de ese plazo, en caso de que el Trabajador considere que su [Sueldo Básico](articulo-6.md) o tiempo de cotización son diferentes a los que le sean acreditados como base para el cálculo preliminar de su Bono de Pensión, tendrá derecho a entregar al [Instituto](articulo-6.md), para que realice la revisión y ajuste que en su caso correspondan, las hojas únicas de servicio que para este efecto le expidan las [Dependencias](articulo-6.md) y [Entidades](articulo-6.md) en que haya laborado, con el propósito de que los ajustes procedentes le sean reconocidos en el cálculo del Bono de Pensión, como parte de los elementos necesarios para sustentar su decisión.
