---
id: urn:lex-mx:federal:statute:lissste:transitory:vigesimo-primero
...
number: "VIGÉSIMO PRIMERO"
aliases: ["LISSSTE — VIGÉSIMO PRIMERO"]
generated: true
...
De conformidad con la fórmula de pago anticipado, el valor de redención expresado en unidades de inversión de los Bonos de Pensión del ISSSTE a la fecha de su emisión será el siguiente: Para determinar el monto de los Bonos de Pensión del ISSSTE en cada caso particular, se deberá multiplicar el numeral que corresponda en la tabla a los años de cotización y edad del Trabajador, por el [Sueldo Básico](articulo-6.md) mensual, elevado al año y expresado en unidades de inversión, que estuviere percibiendo el Trabajador al último día del año anterior a que entre en vigor esta Ley.
