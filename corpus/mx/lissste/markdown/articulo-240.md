---
id: urn:lex-mx:federal:statute:lissste:article:240
...
La [Reserva](articulo-6.md) de operación para contingencias y financiamiento se constituirá, incrementará o reconstituirá trimestralmente hasta alcanzar un monto equivalente a sesenta días naturales del ingreso total del [Instituto](articulo-6.md) en el año anterior, excluyendo los recursos correspondientes al seguro de retiro, cesantía en edad avanzada y vejez y al [Fondo](articulo-6.md) de la Vivienda.

Además de los ingresos ordinarios por [Cuotas](articulo-6.md) y [Aportaciones](articulo-6.md), a la Reserva de operación para contingencias y financiamiento podrán afectarse los recursos que de manera extraordinaria obtenga el Instituto. La Junta Directiva dictará, en su caso, el acuerdo respectivo, mismo que, automáticamente, modificará el programa anual de administración y constitución de Reservas.
