...
Las multas que impongan administrativamente las [Comisiones Supervisoras](articulo-4.md) o el Banco de México a las [Entidades Financieras](articulo-4.md), [ITF](articulo-4.md) o sociedades autorizadas para operar con [Modelos Novedosos](articulo-4.md) se harán efectivas por la [Secretaría](articulo-4.md) o el Banco de México, según sea aplicable, una vez que hayan quedado firmes. Las multas a que se refiere este artículo tendrán el carácter de créditos fiscales de acuerdo con el Código Fiscal de la Federación.
