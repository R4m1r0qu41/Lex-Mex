...
Para la aprobación de construcción de Embarcaciones y Artefactos Navales, los navieros o armadores deberán presentar solicitud por escrito a la [Dirección General](articulo-10.md) y adjuntar lo siguiente:
...
e) Cronograma de construcción, y

f) Original y copia, según sea el caso, de los planos que se señalan en las fracciones siguientes de este artículo;

II. De eslora menor de quince metros con cubierta, además de lo indicado en la fracción anterior:

a) Arreglo general (perfil y planta); b) Cubiertas y acomodaciones;
...
f) Sistemas de combustible, y

g) Esquema de luces de Navegación;
...
k) Sistemas de contraincendio, y

l) Instalación eléctrica (energía principal);
...
e) Localización de marcas de calado; f) Equipos de carga;
...
j) Plano de ubicación y capacidad de tanques, y

k) Cálculo de estabilidad preliminar;
...
Las Embarcaciones o Artefactos Navales de pasaje, de recreo y deportivas en su modalidad de [Turismo Náutico](articulo-10.md), además de lo señalado en las fracciones II a V de este artículo, según corresponda, plano indicando la ubicación de los asientos fijos, equipos y mobiliario para servicio.

Las [Embarcaciones Menores](articulo-10.md) de quince metros de eslora sin cubierta, únicamente presentarán los planos de arreglo general, perfil exterior, esquema de luces de Navegación y detalles de construcción que demuestren que la Embarcación cumplirá con los requisitos de seguridad para el servicio al que se destine;
...
c) De instalaciones eléctricas (si aplica), y

d) Esquema de luces de Navegación;
...
h) Mamparos estancos; i) Mamparos estructurales;
...
u) Base para equipo de anclaje, industrial, y

v) Cálculo de estabilidad preliminar, y

VIII. Diques flotantes, además de lo indicado en la fracción I de este artículo, los planos que a continuación se señalan:
...
h) Instalación eléctrica, e

i) Distribución del departamento de máquinas.
