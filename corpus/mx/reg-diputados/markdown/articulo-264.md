---
id: urn:lex-mx:federal:regulation:reg-diputados:article:264
...
number: "264"
aliases: ["REG-DIPUTADOS — Artículo 264"]
generated: true
...
1. Todo individuo que pretenda realizar cabildeo por más de una vez en la [Cámara](articulo-2.md), deberá inscribirse al inicio de cada legislatura, en un registro público, que elaborará la [Mesa Directiva](articulo-2.md), el cual se difundirá semestralmente en la [Gaceta](articulo-2.md) y en la página electrónica, con los datos proporcionados por quienes se registren.

2. La inscripción tendrá vigencia por el tiempo que dure la legislatura correspondiente.

3. No podrán llevar a cabo actividades de cabildeo los servidores públicos durante el ejercicio de sus funciones; así como sus cónyuges y sus parientes por consanguinidad o afinidad hasta el cuarto grado. Numeral adicionado DOF 18-10-2013
